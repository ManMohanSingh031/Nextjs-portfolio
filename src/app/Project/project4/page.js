...
import project4 from "../../../assets/netflixgpt.png"; 
    ...
    <div className="md:p-10 p-5 bg-gradient-to-b from-gray-100 to-gray-200 text-blue-950">
      <div className="flex flex-col md:flex-row items-center justify-between mb-8  md:mt-10">
        ...
        <div className="md:w-1/2 mb-4 md:mb-0 md:pl-20">
          ...
          NetflixGPT
          <br /> (A Video Streaming Platform)
          </h1>
          <div className="flex flex-col md:space-x-4 md:flex-row">
            <a
              href="https://netflix-gpt-ashy-ten.vercel.app/" // Replace with actual live link URL
              target="_blank"
            ...
            <a
              href="https://github.com/ManMohanSingh031/NetflixGPT" // Replace with actual GitHub URL
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="md:w-1/2 md:pr-20">
          ...
          <Image
              src={project4} // Replace with actual image URL
              alt="Project 1"
              width={800}
              height={500}
              objectFit="cover"
      ...
      <div className="text-center mb-10  md:mt-20">
        ...
        • Leveraged React, Redux, and Tailwind CSS to create a video streaming
          platform. Integrated user authentication using Firebase and fetched
          movie data via the TMDB Movie API.
          <br />
          • Achieved a 30% performance boost by employing code splitting
          techniques. Enhanced readability and maintainability by creating
          reusable components.
          <br />
          • Overcame Challenges: Successfully managed complex components,
          handled API data fetching, and ensured seamless user experiences
          post-authentication.
          <br />• Ensured seamless user experiences across various devices by
          meticulously implementing responsive design principles, allowing users
          to enjoy the video streaming platform on desktops, tablets, and mobile
          devices alike
        </p>
